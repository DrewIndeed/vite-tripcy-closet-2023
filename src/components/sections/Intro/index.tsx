...
const Intro = (props: Props) => {
  ...
  return (
    <IntroWrapper
      id="intro"
      style={{ backgroundColor: bgColorHex, willChange: "transform" }}
    >
      <div className="svg-wrapper">
        ...
        >
          <g id="part1" style={{ willChange: "transform" }}>
            <path
              fill={svgColorHex}
          ...
          <g id="part2" style={{ willChange: "transform" }}>
            <path
              fill={svgColorHex}
          ...
          <g className="part3" style={{ willChange: "transform" }}>
            <path
              fill={svgColorHex}
      ...
      <div
        ...
        style={{ color: textColorHex, willChange: "transform" }}
      >
        TRIPCY&nbsp;CLOSET
      </div>
    </IntroWrapper>
